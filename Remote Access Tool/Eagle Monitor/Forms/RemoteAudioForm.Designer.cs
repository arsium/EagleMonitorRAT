namespace EagleMonitor.Forms
{
    partial class RemoteAudioForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.currentMachineDevicesGuna2ComboBox.FocusedState.Parent = this.currentMachineDevicesGuna2ComboBox;
            ...
            this.currentMachineDevicesGuna2ComboBox.HoverState.Parent = this.currentMachineDevicesGuna2ComboBox;
            this.currentMachineDevicesGuna2ComboBox.ItemHeight = 30;
            this.currentMachineDevicesGuna2ComboBox.ItemsAppearance.Parent = this.currentMachineDevicesGuna2ComboBox;
            ...
            this.currentMachineDevicesGuna2ComboBox.ShadowDecoration.Parent = this.currentMachineDevicesGuna2ComboBox;
            ...
            this.audioDevicesGuna2ComboBox.FocusedState.Parent = this.audioDevicesGuna2ComboBox;
            ...
            this.audioDevicesGuna2ComboBox.HoverState.Parent = this.audioDevicesGuna2ComboBox;
            this.audioDevicesGuna2ComboBox.ItemHeight = 30;
            this.audioDevicesGuna2ComboBox.ItemsAppearance.Parent = this.audioDevicesGuna2ComboBox;
            ...
            this.audioDevicesGuna2ComboBox.ShadowDecoration.Parent = this.audioDevicesGuna2ComboBox;
