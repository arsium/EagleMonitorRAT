...
{
    public partial class RemoteCamera : FormPattern
    {
        ...
        internal RemoteCamera(string baseIp)
        {
            this.baseIp = baseIp;
            InitializeComponent();
        ...
        {
            if (Directory.Exists(ClientHandler.ClientHandlersList[baseIp].clientPath + "\\" + "Camera") == false)
                Directory.CreateDirectory(ClientHandler.ClientHandlersList[baseIp].clientPath + "\\" + "Camera");
