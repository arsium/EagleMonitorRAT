...
/*
|| Sources :  https://github.com/kwwwvagaa/NetWinformControl
*/
namespace EagleMonitor.Controls
{
    public class CustomTabControls : TabControl
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="TabControlExt" /> class.
		/// </summary>
		public CustomTabControls() : base()
		{
			SetStyles();
			//this.Multiline = true;
		...
		private Color closeBtnColor_Renamed = Color.FromArgb(255, 85, 51);
		...
		private Color COLOR_FORE_BASE = Color.FromArgb(0, 0, 0);

		public Color ForeColorBase
		{
			get
			{
