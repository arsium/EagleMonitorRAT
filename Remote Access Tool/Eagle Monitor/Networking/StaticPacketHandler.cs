...
{
    internal class StaticPacketHandler
    {
        public delegate IPacket PacketParser(IPacket packet, ClientHandler clientHandler);

        public static PacketParser packetParser;
        static StaticPacketHandler() 
        {
            packetParser = new PacketParser(ParsePacket);
        }

        public static void Log(IAsyncResult ar) 
        {
        ...
        public static IPacket ParsePacket(IPacket packet, ClientHandler clientHandler)
        {
            switch (packet.packetType)
            {
                case PacketType.CONNECTED: 
